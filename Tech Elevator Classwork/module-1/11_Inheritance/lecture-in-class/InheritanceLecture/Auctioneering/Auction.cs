...
namespace InheritanceLecture.Auctioneering
{
    ...
    public class Auction 
    {
        ...
        public virtual bool PlaceBid(Bid offeredBid)
        {
            ...
            Console.WriteLine($"Current High Bid: {CurrentHighBid.BidAmount}");
            // Return if this is the new highest bid
            return isHighBid;
        }
       //here is an exapmle of an OVERLOADED method - a method with the same name and return type, but different number or type of parameters
        public bool PlaceBid(Bid offeredBid, string bidderName)
        {
            // Print out the bid details.
            Console.WriteLine(offeredBid.Bidder + " bid " + offeredBid.BidAmount.ToString("C"));
