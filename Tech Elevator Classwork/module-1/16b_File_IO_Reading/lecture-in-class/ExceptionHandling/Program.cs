...
namespace ExceptionHandling
{
    class Program
    {
          ...
          */
            ...
            */
            try
            {
                ...
                DoSomethingDangerous(1);  // throws an ArrayIndexOutOfBoundsException
            ...
            {
                Console.WriteLine("Don't divide by zero, you dumpkus!");
            }
            ...
            */
            try
            {
                ...
                {
                    Console.WriteLine("No overtime for you!");
                }
            }
            catch (FormatException e) 
            {
               
                Console.WriteLine("Please enter a whole number with just digits.");
            }
            catch (Exception e)
            ...
            */
            ...
            catch (ArgumentOutOfRangeException e)
            {
                ...
                Console.WriteLine(e.ActualValue + " " + e.ParamName + " just doesn't make sense.");
        ...
        */
        ...
        private static void DoSomethingDangerous(int y)
        {
