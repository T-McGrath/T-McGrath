...
namespace USCitiesAndParks.DAO
{
    public class ParkSqlDao : IParkDao
    {
        ...
        {
            Park newPark = null;
            string sql = "INSERT INTO park (park_name, date_established, area, has_camping) OUTPUT INSERTED.park_id VALUES (@park_name, @date_established, @area, @has_camping);";
            try
            {
                int newParkId;
            ...
            {
                throw new DaoException($"An error occurred", ex);
