...
// ASK IF THE COMMENTED OUT STUFF IS BETTER/WORSE PRACTICE THAN HOW THE METHOD IS CURRENTLY SET UP.
        public Timesheet UpdateTimesheet(Timesheet timesheet)
        {
            ...
            try
            {
                ...
                //updatedTimesheet = GetTimesheetById(timesheet.TimesheetId); 
            }
            catch (SqlException ex)
            {
