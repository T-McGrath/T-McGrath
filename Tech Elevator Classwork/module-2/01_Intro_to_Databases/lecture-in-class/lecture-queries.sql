...
--SELECT * FROM state where census_region <> 'West' OR census_region IS NULL
...
---SELECT park_name, area * 1000 AS area_in_square_meters FROM park
...
--SELECT city_name
--FROM city WHERE city_name LIKE '%Falls'
...
WHERE date_established < '1971-11-12';

SELECT park_name, date_established FROM park
WHERE date_established <= '1971';
