...
--SELECT state_name FROM [state]; -- [] allows you to use keywords as names
...
--FROM city
--ORDER BY city_name asc -- Sort in ascending order of city name
