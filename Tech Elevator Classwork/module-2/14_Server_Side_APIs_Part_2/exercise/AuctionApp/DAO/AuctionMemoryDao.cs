...
namespace AuctionApp.DAO
{
    public class AuctionMemoryDao : IAuctionDao
    {
        ...
        private int NextId() // This is what makes the IDs automatically increment, regardless of what is included in the POST request.
        {
            int maxId = 0;
        ...
        {
            Auction old = GetAuctionById(updated.Id);
            if (old != null)
            {
                updated.Id = old.Id;
                auctions.Remove(old);
