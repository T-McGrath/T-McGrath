...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const reviewButt = document.getElementById("btnToggleForm");
  reviewButt.addEventListener("click", showHideForm);

  const saveReviewButt = document.getElementById("btnSaveReview");
