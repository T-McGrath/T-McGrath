...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const allNumButts = document.querySelectorAll(".number");
  allNumButts.forEach(num => {
  ...
  const operatorButts = document.querySelectorAll("button.operator");
  operatorButts.forEach(butt => {
  ...
  const equalButt = document.querySelector("button.equal-sign");
