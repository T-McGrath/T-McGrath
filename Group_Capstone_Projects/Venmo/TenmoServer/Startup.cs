...
namespace TenmoServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            IAccountDao accountDao = new AccountSqlDao(connectionString);
            ...
            services.AddTransient<IAccountDao>(sp => new AccountSqlDao(connectionString)); // Trevor added this line.
            services.AddTransient<ITransferDao>(sp => new TransferSqlDao(connectionString, accountDao, userDao)); // Trevor added this line.
