...
namespace Capstone
{
    public class Vending
    {
        ...
        public void FinishTransaction()
        {
            ...
            Console.WriteLine($"Number of quarters returned: {numQuarters}");
            Console.WriteLine($"Number of dimes returned: {numDimes}");
            Console.WriteLine($"Number of nickels returned: {numNickels}\n");
        }
    }
}
