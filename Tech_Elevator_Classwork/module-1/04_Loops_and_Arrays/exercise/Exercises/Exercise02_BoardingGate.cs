...
namespace Exercises
{
    public class Exercise02_BoardingGate
    {
        ...
        */
        ...
        {
            bool[] seatAvailability = new bool[numberOfSeats];
            for (int i = 0; i < seatAvailability.Length; i++)
            {
                seatAvailability[i] = IsAvailable;
            }
        ...
        */
        public int GetAvailableSeatCount(bool[] seatingChart)
        {
            ...
            {
                if (seatingChart[i]) // This element will either be true or false.
                {
                    numSeatsAvailable++;
                }
            }
        ...
        */
        ...
        public int GetNumberOfFullRows(bool[] seatingChart)
        {
            ...
            for (int i = 0; i < seatingChart.Length; i++)
            {
                ...
                if (!seatingChart[i]) // Seat is NOT available.
                {
                    fullSoFar++;
                }                
                if (fullSoFar == 3)
