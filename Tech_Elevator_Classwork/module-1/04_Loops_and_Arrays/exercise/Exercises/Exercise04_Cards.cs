...
namespace Exercises
{
    public class Exercise04_Cards
    {
        ...
        */
        ...
        {
            string[] fourCardHand = new string[4];
            for(int i = 1; i < hand.Length; i++)
            {
                fourCardHand[i - 1] = hand[i];
            }
            return fourCardHand;
        }
        ...
        */
        public string[] DiscardTopCard(string[] remainingDeck)
        {
            ...
            {
                return remainingDeck; //Deck is empty; no need to make a new array.
            }
            string[] deckMinusTopCard = new string[remainingDeck.Length - 1];     
            
            for (int i = 1; i < remainingDeck.Length; i++)
            {
                deckMinusTopCard[i - 1] = remainingDeck[i];
            }
            return deckMinusTopCard;
        }
    }
}
