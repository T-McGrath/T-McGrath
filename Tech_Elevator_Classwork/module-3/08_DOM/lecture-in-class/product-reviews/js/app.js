...
function displayReviews() {
    ...
    reviews.forEach(r => {
        ...
        //insert some contents into the div
        addReviewer(container, r.reviewer);
        addRating(container, r.rating);
        addTitle(container, r.title);
        addReview(container, r.review);
...
function addReview(parent, review) { 
    ...
    feedbackElement.innerText = review;
